...
function AdminUsers() {
  ...
  const loadUsers = async () => {
    try {
      ...
      const res = await fetch("http://203.101.40.119:5000/api/admin/users", {
        headers: {
...
const createUser = async () => {
  ...
  try {
    await fetch("http://203.101.40.119:5000/api/admin/users", {
      method: "POST",
      headers: {
  ...
  <input
    ...
    onBlur={async (e) => {
      try {
        await fetch(
          `http://203.101.40.119:5000/api/admin/users/${u.id}/device-limit`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
  ...
  />
        ...
        <td>
          <button
            onClick={async () => {
              await fetch(
                `http://203.101.40.119:5000/api/admin/users/${u.id}/toggle`,
                {
                  method: "PATCH",
                  headers: {
                    Authorization: `Bearer ${localStorage.getItem("adminToken")}`
