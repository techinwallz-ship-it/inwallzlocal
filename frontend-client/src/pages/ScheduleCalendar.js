...
const loadPlaylists = async () => {
  ...
  const res = await fetch(
    `http://203.101.40.119:5000/api/playlists?userId=${user.userId}`
  );
  ...
  const loadSchedules = async () => {
    ...
    const upcomingRes = await fetch(
        `http://203.101.40.119:5000/api/schedules/upcoming?userId=${user.userId}`
      );
    const completedRes = await fetch(
      `http://203.101.40.119:5000/api/schedules/completed?userId=${user.userId}`
    );
  ...
  const toggleSchedule = async (id) => {
    await fetch(`http://203.101.40.119:5000/api/schedules/${id}/toggle`, {
      method: "PATCH"
    });
    loadSchedules();
  };
  ...
  const deleteSchedule = async (id) => {
    ...
    await fetch(`http://203.101.40.119:5000/api/schedules/${id}`, {
      method: "DELETE"
    });
...
const handleUpdateSchedule = async () => {
  await fetch(
    `http://203.101.40.119:5000/api/schedules/${editingSchedule.id}`,
    {
      method: "PUT",
